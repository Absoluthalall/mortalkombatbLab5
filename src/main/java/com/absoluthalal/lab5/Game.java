...
import com.absoluthalal.lab5.fightProcess.CharacterAction;
import com.absoluthalal.lab5.fightProcess.Fight;
import com.absoluthalal.lab5.fightProcess.ChangeTexts;
...
public class Game {
    ...
    public Human NewHuman(JProgressBar pr1){
        Human human = new Human (1,80,300,1);
        action.HP(human, pr1);

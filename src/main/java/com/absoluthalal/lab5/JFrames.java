package com.absoluthalal.lab5;


import com.absoluthalal.lab5.player.Human;
import com.absoluthalal.lab5.player.Items;
...
public class JFrames extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        playerPicture.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Player.png"))); // NOI18N
        ...
        chooseOptionBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Варианты усиления", "Больше урон", "Больше здоровье" }));
        ...
        newLevelLabel.setText("Новый уровень - выберите улучшение");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            switch(chooseOptionBox.getSelectedItem().toString()) {
                ...
                checkAndDisableButtons() ;
                locationLable.setText("Локация №"+game.getFight().getCurrentLocation());

                jDialog1.dispose();

            
        } catch (IllegalArgumentException ex) {
            JOptionPane.showMessageDialog(jDialog1, "Необходимо что-то выбрать.", "Ошибка",  JOptionPane.ERROR_MESSAGE);
        }    
    ...
    private void confirmCountButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmCountButtonActionPerformed
       try {
           ...
           jFrame1.setVisible(rootPaneCheckingEnabled);
            ...
            game.getFight().setCountOfAllLocation(locationsCount);
            game.getFight().setCurrentLocation(0);
           ...
           JOptionPane.showMessageDialog(rootPane, "Ошибка, повторите ввод", "Ошибка",  JOptionPane.ERROR_MESSAGE);
